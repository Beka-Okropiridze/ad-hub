        ...
        <footer className=' bg-black h-96 w-full absolute'>
            <div className='max-w-screen-xl mx-auto lg:px-6 '>
                ...
                <div className="flex items-center justify-between p-8 mt-16">
                    <span className="all-rights text-white font-light text-md">© 2023 <a href="#" className="hover:underline">AdHub™</a>. All Rights Reserved.
                    </span>
                    <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                        <a href="#" className=" text-white font-light text-md">
