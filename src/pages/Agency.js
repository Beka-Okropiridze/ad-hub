  ...
  return (
    <div>
      ...
      <div className="Cover-wrapper">
        ...
        <div className=" absolute mt-72 pl-36 flex flex-col items-start max-w-xl mx-auto readMore-wrapper ">
          ...
          <button type="button" className="mt-12 readMore-btn text-white w-48 hover:underline decoration-1 bg-violet-500 hover:bg-violet-800 focus:ring-4 focus:ring-violet-300 rounded-3xl px-2 py-2.5 mr-2 mb-2 font-extralight">Read More</button>
        </div>
      </div>
