  ...
  return (
    <div>
      ...
      <div className="Cover-wrapper">
        ...
        <div className="relative 2xl:max-w-screen-2xl 2xl:mx-auto 2xl:px-8">
          <Header />
        </div>

        <div className="relative flex flex-col items-start max-w-screen-xl p-4 mt-32 mx-auto lg:px-10 readMore-wrapper 2xl:max-w-screen-2xl 2xl:mx-auto 2xl:px-8 ">
      ...
      <div className="2xl:max-w-screen-2xl 2xl:mx-auto 2xl:px-8">
        <Footer />
      </div>
