  ...
  return (
    <div>
      ...
      <div className="Cover-wrapper">
        ...
        <div className="relative flex flex-col items-start max-w-screen-xl p-4 mt-32 mx-auto lg:px-10 2xl:max-w-screen-2xl 2xl:px-6 2xl:mx-auto 2xl:justify-start readMore-wrapper">
